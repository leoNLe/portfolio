...
function main() {
  ...
  return (
    ...
    <div className="container-fluid my-5 border about-container">
        
        <div className="row mx-3 pt-4 pb-3 title-border overflow-auto">
        ...
        <div className="row mx-3 mb-3 ">
            ...
            <div className="col-12 overflow-auto">
                ...
                <img src={penguin} alt="Penguin" className="float-left about-img img-fluid mt-3 mb-1 pr-3"/> 
